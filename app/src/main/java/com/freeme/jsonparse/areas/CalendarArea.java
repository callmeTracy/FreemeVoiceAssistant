...
import com.freeme.jsonparse.results.CalendarResults;

public class CalendarArea {
    private String raw_text;
    private String parsed_text;
    private List<CalendarResults> results;
    ...
    public List<CalendarResults> getResults() {
        return results;
    }

    public void setResults(List<CalendarResults> results) {
