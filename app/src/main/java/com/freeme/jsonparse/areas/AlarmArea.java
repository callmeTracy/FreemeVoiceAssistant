...
import com.freeme.jsonparse.results.AlarmResults;

public class AlarmArea {
    private String raw_text;
    private String parsed_text;
    private List<AlarmResults> results;
    ...
    public List<AlarmResults> getResults() {
        return results;
    }

    public void setResults(List<AlarmResults> results) {
